      ...
      <>
        ...
        <main className="px-5 md:px-8 py-16 md:py-24">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="text-[11px] font-bold tracking-[0.18em] uppercase font-mono text-pg-ink-400 mt-5">
              Segera
            </div>
  ...
  return (
    <>
      ...
      <main className="pb-24 md:pb-0">
        {/* HERO */}
        <section
          className="px-5 md:px-8 pt-10 md:pt-14 pb-10"
          style={{ background: "linear-gradient(180deg, #fefbf3 0%, var(--pg-paper) 100%)" }}
        >
          <div className="max-w-4xl mx-auto">
            <Link
              href="/sertifikasi"
              className="inline-flex items-center gap-1.5 text-[13px] font-bold text-pg-ink-500 no-underline mb-5"
            >
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                className="text-[11px] md:text-[12px] font-bold tracking-[0.18em] uppercase font-mono"
                style={{ color: GOLD }}
              >
                Paspor Perantau Global
              </div>
            </div>
            <h1 className="text-[30px] md:text-5xl font-extrabold tracking-[-0.03em] leading-[1.05] mt-4">
              {cert.name}
            </h1>
            ...
            <div
              className="inline-flex items-center gap-2 mt-6 px-3.5 py-2 rounded-full text-[13px] font-bold"
              style={{ background: "rgba(201,138,20,0.12)", color: GOLD }}
            >
              {cert.price}
              {cert.priceNote ? (
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-5">
              {detail.howItWorks.map((s, i, arr) => (
                <div key={s} className="grid grid-cols-[28px_1fr] gap-3" style={{ paddingBottom: i === arr.length - 1 ? 0 : 16 }}>
                  <div className="relative">
                    ...
                    {i < arr.length - 1 && (
                      <div className="absolute left-[11px] top-[26px] -bottom-4 w-0.5" style={{ background: "rgba(201,138,20,0.30)" }} />
                    )}
                  </div>
        ...
        <section className="px-5 md:px-8 pb-12 md:pb-16">
          <div className="max-w-4xl mx-auto">
            <div
              ...
              style={{
                background: "linear-gradient(140deg, #c98a14 0%, #8a5e0a 55%, #5e3f06 100%)",
            ...
            <ul className="flex flex-col gap-2.5 mt-6">
              {detail.why.map((w) => (
                <li key={w} className="flex items-start gap-3 text-[14px] md:text-[15px] text-pg-ink-700">
                  <span style={{ color: GOLD }} className="mt-0.5 shrink-0">
        ...
        <section className="px-5 md:px-8 pb-16 md:pb-24">
          <div className="max-w-4xl mx-auto">
            <div className="rounded-3xl bg-pg-ink-900 text-white p-6 md:p-10 text-center">
              <h2 className="text-[24px] md:text-[36px] font-extrabold tracking-[-0.02em] leading-[1.1]">
                Ambil {cert.name} di aplikasi.
              </h2>
              <p className="text-[14px] md:text-[16px] text-white/70 leading-relaxed mt-3 max-w-prose mx-auto">
                Daftar gratis, lalu ambil Paspor Perantau Global langsung dari
                akun kamu. Satu akun untuk lowongan & sertifikasi.
              </p>
              <a
                href={APP_URL}
                className="inline-flex items-center justify-center gap-2 min-h-[52px] px-6 mt-6 text-base font-bold rounded-2xl text-white no-underline"
                style={{ background: "var(--pg-red-600)" }}
              >
                Buka Perantau Global <Icon name="arrow_right" size={18} />
              </a>
            </div>
          </div>
        </section>
