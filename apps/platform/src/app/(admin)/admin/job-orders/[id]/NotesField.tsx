...
import { updateJobOrderNotes } from "../actions";

export default function NotesField({ id, initial }: { id: string; initial: string }) {
  ...
  function save() {
    ...
    start(async () => {
      try {
        await updateJobOrderNotes(id, value);
        setSaved(true);
      } catch (err) {
  ...
  return (
    <div>
      ...
      <textarea
        ...
        rows={4}
        placeholder="Catatan internal — kontak PIC, deadline khusus, dll."
