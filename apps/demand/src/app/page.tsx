  ...
  return (
    <main className="corp">
      ...
      <section className="corp-hero" id="top">
        ...
        <div className="corp-hero-statement"><Image className="corp-hero-visual" src="/images/hero-arches.jpg" alt="Indonesian professionals prepared for international work" fill priority sizes="(max-width: 800px) 100vw, 38vw" /><div className="corp-hero-statement-content"><div className="corp-diamond">◆</div><p>Business need.<br />Workforce fit.<br /><b>Operational confidence.</b></p><span>FROM INDONESIA, WITH CARE</span></div></div>
      </section>

      <section className="corp-proof"><div><strong>01</strong><p>Clearer role and<br />volume brief</p></div><div><strong>02</strong><p>Less sourcing<br />friction</p></div><div><strong>03</strong><p>Documented hiring<br />route</p></div><div><strong>04</strong><p>Support through the<br />first 90 days</p></div></section>
      ...
      <section className="corp-clients"><div className="corp-clients-heading"><p className="corp-kicker">THE BUSINESS IMPACT</p><h2>Evidence that helps you <em>move with confidence.</em></h2><p>Every conversation is anchored to a practical employer outcome: clearer roles, lower sourcing friction, a responsible route, and a stronger start for the people you hire.</p></div><div className="corp-logo-grid"><div>Role clarity</div><div>Talent fit</div><div>Readiness insight</div><div>Route visibility</div><div>Aftercare</div><div>Business continuity</div></div></section>

      <section className="corp-regions" id="regions"><div className="corp-regions-title"><p className="corp-kicker">MARKET CONVERSATIONS</p><h2>Indonesia expertise.<br /><em>Market-aware delivery.</em></h2></div><div className="region-cards"><Link href="/saudi-gcc" className="region-card region-live"><p>PRIORITY MARKET</p><h3>Saudi Arabia<br />&amp; GCC</h3><span>Discuss your workforce need <b>→</b></span></Link><Link href="/europe" className="region-card region-concept"><p>BULGARIA-LED EUROPE</p><h3>Europe</h3><span>Explore employer relevance <b>→</b></span></Link></div></section>
      ...
      <section className="corp-home-insights"><div><p className="corp-kicker">ARTICLES</p><h2>Perspectives on people<br />and <em>global work.</em></h2><Link href="/articles">View all articles →</Link></div><div className="corp-home-insight-list"><article><span>01</span><p>Responsible recruitment starts long before the interview.</p><b>Read article</b></article><article><span>02</span><p>What employers need from a cross-border talent partner.</p><b>Read article</b></article><article><span>03</span><p>Designing a better first 90 days for international talent.</p><b>Read article</b></article></div></section>
