  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(180deg,rgba(16,27,16,.74) 0%,rgba(16,27,16,.5) 38%,rgba(16,27,16,.56) 72%,rgba(16,27,16,.9) 100%)" }} />
      ...
      {/* content */}
      <div style={{ position: "relative", zIndex: 10, maxWidth: 1280, margin: "0 auto", padding: "182px 40px 0", textAlign: "center" }}>
        <span className="as" style={{ width: 60, height: 60, display: "inline-block", marginBottom: 28, position: "relative", animationDelay: ".05s" }}>
        ...
        <div className="anim ar" style={{ fontFamily: "var(--font-mono)", fontSize: 11.5, letterSpacing: ".22em", color: "#E1C583", marginBottom: 26, animationDelay: ".12s" }}>
          REGISTERED INDONESIAN TALENT PARTNER &nbsp;·&nbsp; SAUDI ARABIA &amp; GCC
        </div>
        <h1 style={{ margin: "0 auto", maxWidth: 900, fontFamily: "var(--font-display)", fontWeight: 500, fontSize: "clamp(40px,4.8vw,66px)", lineHeight: 1.03, letterSpacing: "-.018em", color: "#F5F1E6", textShadow: "0 2px 30px rgba(10,18,10,.5)" }}>
        ...
        <p className="anim af" style={{ margin: "26px auto 36px", fontSize: 17, lineHeight: 1.62, color: "#E4E0CC", maxWidth: 610, animationDelay: ".66s", textWrap: "pretty", textShadow: "0 1px 16px rgba(10,18,10,.5)" }}>
        ...
        <div className="anim ar" style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", animationDelay: ".76s" }}>
        ...
        <svg className="anim adraw" width="1" height="46" style={{ display: "block", margin: "44px auto 0", overflow: "visible" }}>
          <line x1="0.5" y1="0" x2="0.5" y2="46" stroke="#B28A48" strokeWidth="1.4" strokeDasharray="46" strokeDashoffset="46" />
        </svg>
      </div>

      {/* trust strip */}
      <div className="anim af" style={{ position: "relative", zIndex: 10, marginTop: 38, borderTop: "1px solid rgba(216,185,120,.2)", background: "rgba(16,27,16,.66)", backdropFilter: "blur(3px)", animationDelay: ".95s" }}>
