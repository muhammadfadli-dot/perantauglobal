...
export default function HomePage() {
  return (
    <main className="corp">
      ...
      <section className="corp-contact" id="contact"><div className="corp-contact-decoration" aria-hidden="true"><span>ROLE FIT</span><i /><span>MARKET ROUTE</span><i /><span>AFTERCARE</span></div><p className="corp-kicker">EMPLOYER INQUIRY</p><h2>Grow Your Business With Indonesian Talent You Can <em>Hire With Confidence</em></h2><a href={waLink("Hello DTG, I would like to discuss an employer workforce need.")} target="_blank" rel="noreferrer" className="corp-button">Discuss your needs <span>→</span></a><p className="corp-contact-note">WhatsApp-first for employer conversations. Tell us where capacity, service quality, or continuity is under pressure.</p></section>
