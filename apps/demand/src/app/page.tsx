  ...
  return (
    <main className="corp">
      ...
      <section className="corp-hero" id="top">
        ...
        <div className="corp-hero-copy"><div className="corp-hero-primary"><h1>Grow Your Business With Indonesian Talent You Can <em className="corp-hero-highlight">Hire With Confidence</em></h1><p className="corp-lede">When service quality, capacity, or operational continuity is under pressure, DTG helps turn a workforce need into a clearer hiring route—from relevant talent and readiness evidence to documentation, mobility, and aftercare.</p><div className="corp-actions"><a className="corp-button" href={waLink("Hello DTG, I would like to discuss an employer workforce need.")} target="_blank" rel="noreferrer">Discuss your needs</a><Link className="corp-text-link" href="/services">See how DTG supports the hiring journey <span>→</span></Link></div></div><div className="corp-hero-trust" aria-label="DTG approach"><span>Employer-first</span><span>Market-aware</span><span>Evidence-led</span></div></div>
      ...
      <section className="corp-contact" id="contact"><div className="corp-contact-decoration" aria-hidden="true"><span>ROLE FIT</span><i /><span>MARKET ROUTE</span><i /><span>AFTERCARE</span></div><p className="corp-kicker">EMPLOYER INQUIRY</p><h2>Ready to build a clearer <em>global workforce route?</em></h2><p className="corp-contact-intro">Start with the business need. DTG will help shape the right conversation around role fit, readiness, and a managed route forward.</p><a href={waLink("Hello DTG, I would like to discuss an employer workforce need.")} target="_blank" rel="noreferrer" className="corp-button">Discuss your needs <span>→</span></a><p className="corp-contact-note">WhatsApp-first for employer conversations. Tell us where capacity, service quality, or continuity is under pressure.</p></section>
