...
export default function ContactPage() {
  return <main className="corp"><CorporateNav />
    ...
    <section className="corp-map-section"><div className="corp-map-placeholder"><div><span>◆</span><p>DTG OFFICE<br /><b>Kuningan business district<br />South Jakarta</b></p><small>Map preview placeholder</small></div></div><div><p className="corp-kicker">VISIT BY APPOINTMENT</p><h2>Find the DTG <em>office.</em></h2><p>This is a visual placeholder for the future office map. Once the final office address and Google Maps listing are approved, it can be replaced with a live map and directions link.</p><a className="corp-button" href="https://www.google.com/maps/search/?api=1&query=Kuningan%20South%20Jakarta" target="_blank" rel="noreferrer">Open area in Google Maps →</a></div></section>
