...
export default async function ProgramLayout({
  ...
  const columns: FooterColumn[] = [
    { label: t("footer.lowonganLabel"), items: t.raw("footer.lowonganLinks") as string[] },
    { label: t("footer.kontakLabel"), items: t.raw("footer.kontakItems") as string[] },
  ];
  return (
    <>
      <Nav anchors={anchors} ctaLabel={t("nav.ctaLabel")} ctaHref={t("nav.ctaHref")} masthead={masthead} />
      {children}
      <Footer
