...
export default function ForCandidatesPage() {
  return <main className="corp"><CorporateNav />
    ...
    <CorporateCtaBanner label="ARE YOU AN EMPLOYER?" title="Looking to hire Indonesian talent?" description="DTG is the right route for employers and authorised demand-side intermediaries with a workforce requirement." />
    <CorporateFooter />
  </main>;
}
