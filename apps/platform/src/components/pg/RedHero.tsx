...
export function RedHero({
  ...
  const padding = size === "sm" ? "px-4 pt-4 pb-3.5" : size === "md" ? "px-5 pt-5 pb-4" : "px-5 pt-8 pb-7";
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <div
          className={`${titleSize} font-extrabold leading-[1.05] tracking-tight mt-1.5 text-balance`}
        >
          {role}.
        </div>
        {meta && meta.length > 0 && (
