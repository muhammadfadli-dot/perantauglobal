...
export default function ContactPage() {
  return <main className="corp"><CorporateNav />
    ...
    <section className="corp-map-section"><div className="corp-map-placeholder"><iframe title="DTG office location at Alamanda Tower" src="https://www.google.com/maps?q=Alamanda%20Tower%20Lantai%2023%20Jl.%20TB%20Simatupang%20No.%2022-26%20Jakarta%20Selatan&output=embed" loading="lazy" referrerPolicy="no-referrer-when-downgrade" /></div><div><p className="corp-kicker">VISIT BY APPOINTMENT</p><h2>Find the DTG <em>office.</em></h2><p>Our office is at Alamanda Tower, Lantai 23, South Jakarta. Please contact the team before visiting.</p><a className="corp-button" href="https://www.google.com/maps/search/?api=1&query=Alamanda%20Tower%20Lantai%2023%20Jl.%20TB%20Simatupang%20No.%2022-26%20Jakarta%20Selatan" target="_blank" rel="noreferrer">Open in Google Maps →</a></div></section>
