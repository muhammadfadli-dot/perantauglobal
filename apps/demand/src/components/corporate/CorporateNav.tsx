  ...
  return (
    <>
      <nav className="corp-nav" aria-label="Primary navigation">
        ...
        <div className="corp-nav-actions"><Link className="corp-nav-talent" href="/for-candidates">For candidates</Link><LanguageSwitch /><a className="corp-nav-cta" href={waLink("Hello DTG, I would like to discuss an employer workforce need.")} target="_blank" rel="noreferrer">Discuss your needs</a><CorporateMobileMenu /></div>
      </nav>
    </>
  );
}
