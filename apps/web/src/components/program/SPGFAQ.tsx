...
const FAQ_KEYS = ["cost", "who", "commission", "area", "voiceNote", "trial", "legit"] as const;

export default function SPGFAQ() {
  const t = useTranslations("program.spg.faq");
  ...
  return (
    <section className="bg-white px-6 py-20 text-[var(--color-dtg-ink)] lg:px-14 lg:py-24">
      <div className="mx-auto grid max-w-[1440px] gap-10 lg:grid-cols-[340px_1fr] lg:gap-16">
        <aside>
          <SectionTag number="08" label="Tanya jawab SPG" />
          <DisplayHeadline size="sidebar" className="mt-4">
            Yang sering{" "}
            <Italic>ditanyakan.</Italic>
          </DisplayHeadline>
