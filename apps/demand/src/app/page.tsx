  ...
  return (
    <main className="corp">
      ...
      <section className="corp-hero" id="top">
        ...
        <div className="corp-hero-copy"><div className="corp-hero-primary"><h1>Build a workforce that performs <em>beyond the hire.</em></h1><p className="corp-lede">DTG turns hard-to-fill roles into a clearer workforce plan—connecting role definition, screened Indonesian talent, a documented recruitment route, and support after placement.</p><div className="corp-actions"><Link className="corp-button" href="/contact">Discuss Your Workforce Needs</Link><Link className="corp-text-link" href="/services">See how we solve workforce gaps <span>→</span></Link></div></div><div className="corp-hero-trust" aria-label="DTG approach"><span>Employer-first</span><span>Market-aware</span><span>Evidence-led</span></div></div>
        <div className="corp-hero-statement"><Image className="corp-hero-visual" src="/images/global-workforce-hero.png" alt="Global professionals moving through an international workplace" fill priority sizes="(max-width: 800px) 100vw, 46vw" /><div className="corp-hero-floating-card"><small>MARKET ROUTE</small><strong>Indonesia → Global</strong><span>Employer conversation</span></div></div>
      </section>
