  ...
  return (
    <main className="corp">
      ...
      <section className="corp-hero" id="top">
        ...
        <div className="corp-hero-statement"><Image className="corp-hero-visual" src="/images/dtg-employer-readiness-hero-v2.png" alt="Indonesian healthcare, hospitality, technical, and logistics professionals reviewing a readiness plan" fill priority sizes="(max-width: 800px) 100vw, 46vw" /><div className="corp-hero-floating-card"><small>MARKET ROUTE</small><strong>Indonesia → Global</strong><span>Employer conversation</span></div></div>
      </section>

      <section className="corp-solution-visual" id="services"><div className="corp-solution-image"><Image src="/images/dtg-workforce-planning-v2.png" alt="An employer and Indonesian workforce consultant reviewing roles, shift coverage, and readiness requirements" fill sizes="(max-width: 800px) 100vw, 46vw" /></div><div className="corp-solution-copy"><p className="corp-kicker">THE EMPLOYER CHALLENGE → THE DTG RESPONSE</p><h2>Turn workforce pressure into <em>business confidence.</em></h2><p>Business ambition can be slowed by pressure on service, capacity, growth, or operational continuity. DTG connects role definition, market-aware sourcing, readiness evidence, documentation, mobility, and aftercare into one controlled hiring journey.</p><div className="corp-solution-points">{capabilities.map(([number, title, detail]) => <div key={number}><b>{number}</b><span><strong>{title}</strong><small>{detail}</small></span></div>)}</div><Link href="/contact" className="corp-solution-link">Talk through a workforce need →</Link></div></section>
